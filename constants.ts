...
export const INITIAL_PLACEHOLDERS = [
    ...
    "Freelance writer portfolio with client testimonials",
    "Digital marketing agency with case studies",
    "Online course platform for professional development",
    "Podcast hosting platform landing",
    "Crypto NFT marketplace homepage",
    "SaaS affiliate program page",
    "Food delivery app landing",
    "Remote work job board",
    "Event planning service with gallery",
    "Car dealership showcase",
    "Insurance quote calculator",
    "Recipe blog with meal plans",
    "Fitness app with workout tracking",
    "Music production studio portfolio",
    "Coworking space booking",
    "Travel booking platform homepage",
    "E-learning for kids platform",
    "Beauty products e-commerce",
    "Home renovation contractor",
    "Personal finance blog with tools",
